...
void network_init(void)
{
	...
	unsigned char tx_mem_conf[8] = {4,4,8,0,0,0,0,0};           // for setting TMSR register
	unsigned char rx_mem_conf[8] = {4,4,8,0,0,0,0,0};          // for setting RMSR register
...
//	socket(1,Sn_MR_UDP,para_port,0);
//	socket(2,Sn_MR_UDP,gcod_port,0);
//		
